...
// import {BOComponentsModule, TranslateService} from "../index";
//
// @Component({
//     selector: 'root-cmp',
//     template: `
...
//             let LoadedModule = getLazyLoadedModule(BOComponentsModule.forChild());
...
//         [Router, Location, NgModuleFactoryLoader],
//         (router: Router, location: Location, loader: SpyNgModuleFactoryLoader) => {
//             let LoadedModule = getLazyLoadedModule(BOComponentsModule.forRoot());
//             loader.stubbedModules = {expected: LoadedModule};
//
//             const fixture = createRoot(router, RootCmp),
//                 injector = getTestBed(),
...
//         [Router, Location, NgModuleFactoryLoader],
//         (router: Router, location: Location, loader: SpyNgModuleFactoryLoader) => {
//             let LoadedModule = getLazyLoadedModule(BOComponentsModule.forChild({isolate: true}));
//             loader.stubbedModules = {expected: LoadedModule};
//
//             const fixture = createRoot(router, RootCmp),
//                 injector = getTestBed(),
